...
export async function createCheckoutSessionHandler(req, res) {
    ...
    try {
        const result = await createCheckoutSession(items, userId);
...
export async function simulatePaymentHandler(req, res) {
    ...
    const mockSession = {
        ...
        customer_details: { email: 'test@sandbox.local' },
    };
